...
function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-blue-700 p-6">
      ...
      <div className={`w-full block flex-grow lg:flex lg:items-center lg:ml-72 lg:w-auto ${isOpen ? 'block' : 'hidden'}`}>
        <div className="text-sm lg:flex-grow">
        
        <Link to="/home" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-black mr-4">
            Home
          </Link>
        ...
        <div>
          <a href="#download" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">
            Download
          </a>
        </div>
      </div>
