...
const Team = () => {
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {team.slice(-5).map((member, index) => (
              <div
                key={index}
                className="flip-card w-60 h-80 relative mx-auto"
              >
                <div className="flip-card-inner w-full h-full absolute transform transition-transform duration-500 hover:rotate-y-180">
                  <div className="flip-card-front bg-white text-center rounded-lg shadow-lg p-4 flex flex-col items-center justify-center border border-red-950">
                    <img
                      src={member.image}
                      alt={member.name}
                  ...
                  <div className="flip-card-back bg-transparent text-center border border-white text-white rounded-lg shadow-lg p-4 flex flex-col items-center justify-center transform rotate-y-180">
  ...
  <div className="relative overflow-hidden">
    <div className="relative container mx-auto px-4 lg:px-8">
      <h2 className="text-4xl font-bold text-center text-teal-600 mb-8 relative z-10">Our Team</h2>

      {/* First row with 3 cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8 relative z-10">
        {team.slice(0, 3).map((member, index) => (
          <div key={index} className="flip-card w-64 h-80 relative mx-auto">
            <div className="flip-card-inner w-full h-full absolute transform transition-transform duration-500 hover:rotate-y-180">
              ...
              <div className="flip-card-back bg-transparent text-center border border-black text-black rounded-lg shadow-lg p-4 flex flex-col items-center justify-center transform rotate-y-180">
                <p className="text-lg">{member.role}</p>
